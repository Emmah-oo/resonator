      ...
      <div className="flex flex-col gap-10 p-12 md:flex-row m-auto md:gap-5 lg:w-[70%] lg:p-0 lg:py-[8rem]">
        ...
        <div className="flex flex-col gap-5 w-[100%]">
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="flex flex-col gap-3 font-light text-slate-300 sm:flex-row md:flex-col lg:gap-[1.5rem]">
              <h1>Start a conversation:</h1>
              <p>podcast@example.com +2 969 866 7033</p>
              <h1 className="lg:mt-[1rem]">Terms & Conditions</h1>
            </div>
            <div className="flex flex-col gap-3 font-light text-slate-300 sm:flex-row md:flex-col lg:gap-[1.5rem]">
              <h1>Find us here:</h1>
              <p>Brooklyn, NY 11201 United States</p>
              <h1 className="lg:mt-[1rem]">Privacy Policy</h1>
            </div>
            <div className="flex flex-col gap-3 font-light text-slate-300 sm:flex-row md:flex-col lg:gap-[1.5rem]">
              <h1>Follow us on:</h1>
              <div className="flex flex-col gap-3 sm:flex-row md:flex-col lg:gap-10">
                ...
                <h1 className="lg:mt-[1rem]">© 2021 Qode Interactive. All Rights Reserved</h1>
              </div>
            </div>
          </div>
        </div>
